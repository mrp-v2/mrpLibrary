...
public class ObjectHolder
{
    ...
    public static final RegistryObject<IRecipeSerializer<?>> CRAFTING_SHAPED_CONFIGURABLE_SERIALIZER;
    public static final RegistryObject<IRecipeSerializer<?>> CRAFTING_SHAPELESS_CONFIGURABLE_SERIALIZER;
    ...
    static
    {
        ...
        CRAFTING_SHAPED_CONFIGURABLE_SERIALIZER =
                RECIPE_SERIALIZERS.register("crafting_shaped_configurable", ConfigurableShapedRecipe.Serializer::new);
        CRAFTING_SHAPELESS_CONFIGURABLE_SERIALIZER = RECIPE_SERIALIZERS
                .register("crafting_shapeless_configurable", ConfigurableShapelessRecipe.Serializer::new);
    }
